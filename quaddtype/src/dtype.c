...
// static PyObject * get_unit(PyObject *scalar) {
//     if (Py_TYPE(scalar) != QuantityScalar_Type) {
//         PyErr_SetString(
//             PyExc_TypeError,
//             "Can only store QuantityScalar in a UnitDType array."
 ...
 */
// QuadDTypeObject * new_unitdtype_instance(PyObject *unit)
// {
 ...
 */
// static QuadDTypeObject * common_instance(QuadDTypeObject *dtype1, QuadDTypeObject *dtype2)
// {
...
// static PyArray_Descr * unit_discover_descriptor_from_pyobject(
//         PyArray_DTypeMeta *NPY_UNUSED(cls), PyObject *obj)
// {
//     if (Py_TYPE(obj) != QuantityScalar_Type) {
//         PyErr_SetString(PyExc_TypeError,
//                 "Can only store QuantityScalar in a QuadDType array.");
//         return NULL;
//     }
...
//  */
// static int unit_setitem(QuadDTypeObject *descr, PyObject *obj, char *dataptr) {
...
//  */
// static PyObject * unit_getitem(QuadDTypeObject *descr, char *dataptr) {
//     double val;
//     /* get the value */
 ...
 */
static PyObject * unitdtype_new(PyTypeObject *NPY_UNUSED(cls), PyObject *args, PyObject *kwds)
{
...
static PyObject * unitdtype_repr(QuadDTypeObject *self)
{
    PyObject *res = PyUnicode_FromFormat(
            "QuadDType(%R)", self->unit);
    return res;
}
