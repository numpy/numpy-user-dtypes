                                   ...
                                   npy_intp *view_offset)
{
    ...
    long in_size = ((StrPtrDTypeObject *)loop_descrs[0])->size;
    long out_size = ((StrPtrDTypeObject *)loop_descrs[1])->size;
...
static int
strptr_to_strptr(PyArrayMethod_Context *context, char *const data[],
               npy_intp const dimensions[], npy_intp const strides[],
               NpyAuxData *NPY_UNUSED(auxdata))
{
    PyArray_Descr **descrs = context->descriptors;
    long in_size = ((StrPtrDTypeObject *)descrs[0])->size;
    long out_size = ((StrPtrDTypeObject *)descrs[1])->size;
    long copy_size;
...
//     if (given_descrs[1] == NULL) {
//         StrPtrDTypeObject *ascii_descr = new_asciidtype_instance(in_size);
...
//     Py_INCREF(given_descrs[0]);
//     loop_descrs[0] = given_descrs[0];
//     long in_size = ((StrPtrDTypeObject *)given_descrs[0])->size;
//     if (given_descrs[1] == NULL) {
