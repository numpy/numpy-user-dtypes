...
static PyObject *
get_unit(PyObject *scalar, UnytDTypeObject *descr)
{
...
common_instance(UnytDTypeObject *dtype1, UnytDTypeObject *dtype2)
{
    ...
    if (get_conversion_factor(dtype1->unit, dtype2->unit, &factor, &offset) <
        0) {
        return NULL;
    }
...
static PyObject *
unytdtype_new(PyTypeObject *NPY_UNUSED(cls), PyObject *args, PyObject *kwds)
{
