...
common_instance(UnytDTypeObject *dtype1, UnytDTypeObject *dtype2)
{
...
static int
unytdtype_setitem(UnytDTypeObject *descr, PyObject *obj, char *dataptr)
{
...
static PyObject *
unytdtype_getitem(UnytDTypeObject *descr, char *dataptr)
{
  double val;
  /* get the value */
...
static PyObject *
unytdtype_new(PyTypeObject *NPY_UNUSED(cls), PyObject *args,
                  PyObject *kwds)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "|O&:UnytDType",
                                     kwargs_strs, &UnitConverter, &unit)) {
        return NULL;
    }
...
static void
unytdtype_dealloc(UnytDTypeObject *self)
{
    Py_CLEAR(self->unit);
...
static PyObject *
unytdtype_repr(UnytDTypeObject *self)
{
...
init_unyt_dtype(void)
{
    ...
    if (PyArrayInitDTypeMeta_FromSpec(&UnytDType,
                                      &UnytDType_DTypeSpec) < 0) {
        return -1;
    }
